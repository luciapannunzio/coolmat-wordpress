...
// We create our intro Custom Post Type
function add_intro()
{
	$labels = array(
		'name' => _x('Intros', 'Post Types', 'Post Type General Name', 'text_domain'),
		'singular_name' => _x('Intro', 'Post Type', 'Post Type Singular Name', 'text_domain'),
	);
	$args = array(
		'labels' => $labels,
...
add_action('init', 'add_intro', 0);


// We add our location Custom Post Type
function add_locations()
{
	$labels = array(
		'name' => _x('Locations', 'Post Types', 'Post Type General Name', 'text_domain'),
		'singular_name' => _x('Location', 'Post Type', 'Post Type Singular Name', 'text_domain'),
	);
	$args = array(
		'labels' => $labels,
		'taxonomies' => array('category'),
...
//  we give it a query as to what description we want back
